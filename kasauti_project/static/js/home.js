...
(function () {
        const canvas = document.getElementById('bgShapeCanvas');
        ...
        // CMYK + Gold Accent Colors for Printing Vibe (light theme friendly)
        const colors = [
            'rgba(0, 166, 255, 0.35)',   // Cyan
            'rgba(255, 0, 127, 0.30)',   // Magenta
            'rgba(201, 151, 63, 0.45)',  // Gold
            'rgba(138, 43, 226, 0.28)'   // Blue-Violet
        ];

        const shapeTypes = ['circle', 'triangle', 'cross', 'hollow-circle'];
        ...
        class GeoShape {
            ...
            draw() {
                ...
                else if (this.type === 'hollow-circle') {
                    ctx.arc(0, 0, this.size, 0, Math.PI * 2);
                    ctx.stroke();
                }
